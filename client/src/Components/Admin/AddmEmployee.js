        ...
        <form>
          <div className="AddEmployee-Contianer">
            ...
            <div className="Job-content">
              ...
              <label>
                {" "}
                username<input id="input" type="text"></input>
              </label>

              <label>
                {" "}
                password<input id="input" type="password"></input>
              </label>
              <label>
                {" "}
                Email<input id="input" type=""></input>
              </label>
              <input
                id="input"
                type="file"
              ...
              <label>
                {" "}
                Mobile number<input id="input" type=""></input>
              </label>
              <label>
                {" "}
                Skills<input id="input" type=""></input>
              </label>
              <label> Bio</label>
              <textarea
                id="w3review"
